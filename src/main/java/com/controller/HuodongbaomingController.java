...
public class HuodongbaomingController {
    ...
    public R page(@RequestParam Map<String, Object> params,HuodongbaomingEntity huodongbaoming, HttpServletRequest request){
		...
		if(tableName.equals("renshi")) {
			huodongbaoming.setRenshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yuangong")) {
			huodongbaoming.setGonghao((String)request.getSession().getAttribute("username"));
		}
