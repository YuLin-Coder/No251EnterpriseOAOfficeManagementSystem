  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">企业OA办公系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																								...
																								<!-- <div v-if="tableName=='renshi'" class="input-group">
			   <div class="label">人事账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.renshizhanghao" class="input" type="text" placeholder="人事账号">
			   </div>
			 </div> -->
			<el-form-item label="人事账号" class="input" v-if="tableName=='renshi'">
			  <el-input v-model="ruleForm.renshizhanghao" autocomplete="off" placeholder="人事账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='renshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='renshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='renshi'" class="input-group">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='renshi'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='renshi'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='renshi'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='renshi'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                            ...
                                                            if((!this.ruleForm.renshizhanghao) && `renshi` == this.tableName){
        this.$message.error(`人事账号不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`renshi` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                        if(`renshi` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
                                                                                                                                                                              this.$http({
