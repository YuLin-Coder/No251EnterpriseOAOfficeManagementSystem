        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.qingjialeixing"
                placeholder="请假类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="请假开始时间" prop="qingjiakaishishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qingjiakaishishijian" 
                type="datetime"
                placeholder="请假开始时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qingjiakaishishijian" label="请假开始时间" prop="qingjiakaishishijian">
              <el-input v-model="ruleForm.qingjiakaishishijian" 
                placeholder="请假开始时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="请假结束时间" prop="qingjiajieshushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qingjiajieshushijian" 
                type="datetime"
                placeholder="请假结束时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qingjiajieshushijian" label="请假结束时间" prop="qingjiajieshushijian">
              <el-input v-model="ruleForm.qingjiajieshushijian" 
                placeholder="请假结束时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjialeixing = true;
            continue;
	            	            ...
	            	            if(o=='qingjiakaishishijian'){
            this.ruleForm.qingjiakaishishijian = obj[o];
	    this.ro.qingjiakaishishijian = true;
            continue;
          }
	            	            if(o=='qingjiajieshushijian'){
            this.ruleForm.qingjiajieshushijian = obj[o];
	    this.ro.qingjiajieshushijian = true;
            continue;
          }
	            	            if(o=='qingjiayuanyin'){
