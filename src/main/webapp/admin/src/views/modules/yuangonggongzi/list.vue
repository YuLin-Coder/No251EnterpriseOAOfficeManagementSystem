  ...
  methods: {
    ...
    async printJson() {
      ...
      for (let i=0; i < this.list.length; i++) {
          ...
          nianfen: this.list[i].nianfen,
          yuefen: this.list[i].yuefen,
          jibengongzi: this.list[i].jibengongzi,
          ticheng: this.list[i].ticheng,
          butie: this.list[i].butie,
          jiangjin: this.list[i].jiangjin,
          kaoqinkoukuan: this.list[i].kaoqinkoukuan,
          wuxianyijin: this.list[i].wuxianyijin,
          shifagongzi: this.list[i].shifagongzi,
          renshizhanghao: this.list[i].renshizhanghao,
