          ...
          <el-form-item class="input" v-if="ruleForm.shenqingriqi" label="申请日期" prop="shenqingriqi">
              <el-input v-model="ruleForm.shenqingriqi" 
                placeholder="申请日期" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="申请用途" prop="shenqingyongtu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="申请用途"
                  v-model="ruleForm.shenqingyongtu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingyongtu" label="申请用途" prop="shenqingyongtu">
                    <span>{{ruleForm.shenqingyongtu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='shenqingyongtu'){
            this.ruleForm.shenqingyongtu = obj[o];
	    this.ro.shenqingyongtu = true;
            continue;
          }
	            	            if(o=='shuliang'){
